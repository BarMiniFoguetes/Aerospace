<?php
echo "<meta http-equiv=\"refresh\" content='0,http://192.168.1.155/freeboard/?load=/sateliteOS.json'>";
exit;
?>
<html>
<head>
...
<img src=logo-sateliteOS-small.png width=330>
</div>
<?php
...
$gyro=`python3 ./MPU9250/example/read9axis.py`;
